...
(function($) {
   ...
   /* ======= Progress bars ======= */
	...
	$(".make").select2({
	  placeholder: "Select Brand : Any Brand",
	  width: '100%'
	});
	$(".model").select2({
	...
	$(".trans").select2({
	  placeholder: "Transmission : Select Transmission",
	  width: '100%'
	});
	$(".cc").select2({
	  placeholder: "CC : Select CC",
	  width: '100%'
	});
	$(".cond").select2({
	  placeholder: "Condition : Select Condition",
	  width: '100%'
	});
	$(".color").select2({
	  placeholder: "Color : Select Color",
	  width: '100%'
	});
	$(".country").select2({
