...
@section('main-content')
  ...
  <main id="mt-main">
    ...
    <section class="mt-contact-banner wow fadeInUp" data-wow-delay="0.4s" style="background-image: url(https://htmlbeans.com/html/schon/images/img43.jpg);">
      <div class="container">
        <div class="row">
            ...
            <div class="holder">
              ...
              <div class="col wow fadeInUp" data-wow-delay="0.4s">
                <div class="img-holder">
                  <a href="#">
                    <img src="https://htmlbeans.com/html/schon/images/img44.jpg" alt="CLARA WOODEN">
              ...
              <div class="col wow fadeInUp" data-wow-delay="0.6s">
                <div class="img-holder">
                  <a href="#">
                    <img src="https://htmlbeans.com/html/schon/images/img45.jpg" alt="JOHN WICK">
                    <ul class="list-unstyled social-icon">
                      <li><i class="fa fa-twitter"></i></li>
                      <li><i class="fa fa-facebook"></i></li>
                      <li><i class="fa fa-linkedin"></i></li>
              ...
              <div class="col wow fadeInUp" data-wow-delay="0.8s">
                <div class="img-holder">
                  <a href="#">
                    <img src="https://htmlbeans.com/html/schon/images/img46.jpg" alt="HARRY KANE">
                    <ul class="list-unstyled social-icon">
                      <li><i class="fa fa-twitter"></i></li>
                      <li><i class="fa fa-facebook"></i></li>
                      <li><i class="fa fa-linkedin"></i></li>
              ...
              <div class="col wow fadeInUp" data-wow-delay="0.10s">
                <div class="img-holder">
                  <a href="#">
                    <img src="https://htmlbeans.com/html/schon/images/img47.jpg" alt="CLARA WOODEN">
                  </a>
                </div>
              </div>
              <!-- col of the Page end -->
    ...
    <section class="mt-workspace-sec wow fadeInUp" data-wow-delay="0.4s">
      ...
      <ul class="list-unstyled work-slider">
        <li>
          <div class="img-holder">
            <img src="https://htmlbeans.com/html/schon/images/img48.jpg" alt="image description">
          </div>
          <div class="img-holder">
            <div class="coll1">
              <img src="https://htmlbeans.com/html/schon/images/img49.jpg" alt="image description">
            </div>
            <div class="coll2">
              <img src="https://htmlbeans.com/html/schon/images/img50.jpg" alt="image description">
            </div>
            <div class="coll3">
              <img src="https://htmlbeans.com/html/schon/images/img51.jpg" alt="image description">
            </div>
          </div>
        </li>
        <li>
